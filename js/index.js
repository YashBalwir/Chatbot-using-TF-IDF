...
var Fake = [
  'Hello this is SmartyAss at your service, How may i help you?',
...
function fakeMessage() {
  ...
  setTimeout(function() {
    ...
    $('<div class="message new"><figure class="avatar"><img src="./img/bot.png" /></figure>' + Fake[i] + '</div>').appendTo($('.mCSB_container')).addClass('new');
    setDate();
    updateScrollbar();
    i++;
  }, 1000 + (Math.random() * 20) * 100);
